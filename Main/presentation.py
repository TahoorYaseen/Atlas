...
timeElapsed = 0
simulationTime = 94#386s is total cycle time + 4 sec of reset time for each cycle
...
x = {'right':[550,550,550], 'down':[755,727,697], 'left':[800,800,800], 'up':[602,627,657]}    
y = {'right':[348,370,398], 'down':[250,250,250], 'left':[498,466,436], 'up':[535,535,535]}
...
def initialize():
    ...
    if(randomGreenSignalTimer):
        ...
        signals.append(ts1)
        ts2 = TrafficSignal(ts1.yellow+ts1.green+4, defaultYellow, random.randint(minTime,maxTime))
        signals.append(ts2)
        ts3 = TrafficSignal(ts2.red+ts2.yellow+ts2.green+4, defaultYellow, random.randint(minTime,maxTime))
        signals.append(ts3)
        ts4 = TrafficSignal(ts3.red+ts3.yellow+ts3.green+4, defaultYellow, random.randint(minTime,maxTime))
        signals.append(ts4)
    else:
        # ts1 = TrafficSignal(0, defaultYellow, random.randint(minTime,maxTime))
        # signals.append(ts1)
...
def showStats():
    ...
    print('Total vehicles passed:',totalVehicles)
    print('Total time:',timeElapsed)
    print('Number of cycles passed',ix-1)
...
def generateVehicles():
    ...
    for i in range(i, len(my_dict) + 1):
        for j in range(4):
            ...
            iterations = [vehicle_type for vehicle_type, count in iterations_dict.items() for _ in range(count)]
            random.shuffle(iterations)
            
            # Calling the iterations in the shuffled order
            for iteration in iterations:
                if j==0 or j==3:
                    Vehicle(1, iteration, j, dir_veh[j], random.randint(0, 1))
                else:
                    Vehicle(random.randint(1, 2), iteration, j, dir_veh[j], random.randint(0, 1))
                
        sum_gr = sum(my_dict[str(i)][1])
        cycle_len = sum_gr + 20
...
#                 thelane=1
#                 def for_loop_1():
#                     Vehicle(thelane, 'bus', j, dir_veh[j], random.randint(0,1))
#                     # time.sleep(1)
#                 def for_loop_2():
#                     Vehicle(thelane, 'car', j, dir_veh[j], random.randint(0,1))
#                     # time.sleep(1)
#                 def for_loop_3():
#                     Vehicle(thelane, 'bike', j, dir_veh[j], random.randint(0,1))
#                     # time.sleep(1)

#             else:
#                 def for_loop_1():
#                     Vehicle(random.randint(1,2), 'bus', j, dir_veh[j], random.randint(0,1))
#                     # time.sleep(1)
#                 def for_loop_2():
#                     Vehicle(random.randint(1,2), 'car', j, dir_veh[j], random.randint(0,1))
#                     # time.sleep(1)
#                 def for_loop_3():
#                     Vehicle(random.randint(1,2), 'bike', j, dir_veh[j], random.randint(0,1))
#                     # time.sleep(1)
#             iterations_dict = {
...
class Main:
    ...
    background = pygame.image.load('C:\Tahoor\simulation\Adaptive-Traffic-Signal-Timer-main\Code\YOLO\darkflow\images\intersection.png')
